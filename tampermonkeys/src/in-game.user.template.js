...
`);
  ...
  const logoUrlPrefix =
    'https://raw.githubusercontent.com/Zashness/rashinban2025/refs/heads/gh-pages/assets/logos/';
  const logos = [
    { src: logoUrlPrefix + 'red-tokyo.png' },
    { src: logoUrlPrefix + 'rashinban-logo.png' },
    { src: logoUrlPrefix + 'geoguessr-logo.png' },
  ];
  initSponsorMarquee({
